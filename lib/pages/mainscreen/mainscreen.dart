...
class _MainScreenState extends State<MainScreen> {
  ...
  Video? _currentVideo; // Add a nullable Video variable to manage the current video.
          ...
          child: Stack(
            children: [
              ...
              if (_currentVideo != null)
                Positioned(
                  bottom: _showBottomNavBar ? 64.0 : 0.0, // Adjust according to the height of the bottom navigation bar
                  left: 0,
                  right: 0,
                  child: MiniPlayer(
                    video: _currentVideo,
